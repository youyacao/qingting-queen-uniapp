...
<template>
	<view class="body">
		...
		<view class="protocols">
			...
			<view class="protocols-text">已阅读并同意<navigator class="protocols-text__navigator" url="/pages/register/agreement/agreement" hover-class="none">《用户使用协议》</navigator></view>
		</view>
